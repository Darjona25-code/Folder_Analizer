...
- **Residual round (2026-09-16) RESOLVED — phase still OPEN, awaiting written
  ...
  33,314,701 B + installed tree (`787525a`). L2 was interpreted as
  "bundle loads both locales" (a live EN→ES switch inside one running GUI
  session is NOT exercised against the artifact — declared openly; stronger
  check is available on request).
