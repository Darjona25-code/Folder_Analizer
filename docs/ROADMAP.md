...
- **Residual round (2026-09-16) RESOLVED — phase still OPEN, awaiting written
  acceptance.** (1) Frozen-engine diff re-run at the close is EMPTY (`git diff
